    ...
    <Card className="max-w-lg mx-auto p-6 shadow-md rounded-lg bg-white border">
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <Input type="number" value={experience} onChange={(e) => setExperience(e.target.value)} min="0" className="mt-1" />
        </div>

        {/* Age */}
        <div>
          <label className="text-sm font-medium text-gray-600">Age</label>
          <Input type="number" value={age} onChange={(e) => setAge(e.target.value)} min="18" className="mt-1" />
        </div>
        ...
        {/* Salary Range */}
        <div>
          <label className="text-sm font-medium text-gray-600">Salary Range (K $)</label>
          ...
          <p className="text-sm text-gray-500 mt-1">Min Salary: {salary}K</p>
        </div>

        {/* Submit Button */}
        <Button className="w-full">Submit Criteria</Button>
      </CardContent>
    </Card>
  );
}
